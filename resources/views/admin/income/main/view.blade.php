			...
			<div class="container">
		        ...
		        <table class="table table-bordered table-striped mt-4">
					...
					<tr>
						...
						<td>{{$data->income_amount }} {{ $data->currency->title}} </td>							
					</tr>
					...
					<tr>
						<th colspan="2">Colleted Remarks</th>
					...
					<div class="col-12 center"> 
						...
						@elseif( $user == $receiver && $status == 2 && $trans == 1 && $show == 0 )
							@php echo "<strong> Collector to Receiver  </strong>" ; @endphp <br><br>
							<a class="btn btn-dark d-print-none" href="{{route('receiver.accept',$array)}}">Accept</a>
	...
	<div class="modal-dialog modal-dialog-centered">
	   <div class="modal-content">
			...
			<div class="col-12 center">
				...
				{{-- {{ QrCode::size(250)->generate('http://192.168.2.7/cashcollectrole/qrcode/scan/'.bin2hex($data->income_ref_no).'/'.$user) }} --}}				
			</div>
			</div>
