        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    ...
                    <i class=" uil-user-exclamation "></i> Departments 
                    </div>
                    <div class="col-md-6 card_butt_part">
                        <a class="btn btn-sm btn-dark" href="{{route('add.department')}}"><i class=" uil-plus "></i>  Add New Department</a>
                    </div>
                </div>
            </div>                 
                        ...
                        @foreach($data as $data)
                            ...
                            <td>
                                <div class="btn-group">
                                        ...
                                        <a class="btn btn-dark " href="{{route('edit.department',$data->id)}}"><i class=" uil-comment-edit"></i> Edit</a>
