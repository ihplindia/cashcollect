        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    ...
                    <i class=" uil-user-exclamation "></i> Branch 
                    </div>
                    <div class="col-md-6 card_butt_part">
                        <a class="btn btn-sm btn-dark" href="{{url('dashboard/branch/add')}}"><i class=" uil-plus "></i> Add New Branch</a>
                    </div>
                </div>
            </div>                 
                ...
                <table id="allTableInfo" class="table table-bordered table-striped table-hover dt-responsive nowrap w-100">
                    ...
                    <tbody>
                       @foreach($data as $data)
                            ...
                            <td>
                                <div class="btn-group">                                    
                                    <a class="btn btn-dark " href="{{route('edit.branch',$data->id)}}"><i class=" uil-comment-edit"></i> Edit </a>                                    
                                </div>
                            </td>
                        </tr>                           
                        @endforeach
